...
contract OxStandard is
    ...
    ReentrancyGuard
{
    // frank: "using" for suger syntax for importing method from libary for centerain datatype
    // frank: https://medium.com/coinmonks/soliditys-using-keyword-c05c18aaa088
    using Address for address;
    using SafeMath for uint256;

    // frank: "indexed" for event log 
    // frank: https://ethereum.stackexchange.com/questions/8658/what-does-the-indexed-keyword-do
    ...
    // frank: parameters to control the sales status on-chain
    enum SaleState {
        NotStarted,
    ...
    constructor(
        ...
        // frank: get random num testnet https://docs.chain.link/docs/get-a-random-number/
    ...
    function mintToken(uint256 amount, bytes calldata signature)
        ...
        returns (bool)
    {
        // frank: may be some cautions when call iscontract() 
        // frank: https://despos1to.medium.com/carefully-use-openzeppelins-address-iscontract-msg-sender-4136cc6ff66d
        // frank: also caution about require(msg.sender == tx.orign) 
    ...
    // frank: randomNuber is returned by chainlink operator
